...
<template>
  ...
  >
    <div class="h-full md:h-screen flex flex-col md:flex-row justify-between">
      <div class="mx-1 md:mx-auto w-full md:w-2/4 flex flex-col justify-around space-y-16 my-10 md:my-20">
        <div class="flex flex-col mx-auto space-y-2">
          <h1 class=" text-3xl md:text-6xl s font-bold tracking-tight">Miko Canares</h1>
          <h2 class="text-1xl md:text-3xl font-semibold">Fullstack Developer</h2>
          <p class="text-sm md:text-base font-sans font-semibold pt-4 text-slate-400">
            Coding adventurer. Bug slayer. Experience conjurer.
          </p>
        </div>
        <div class="hidden md:flex mx-auto text-lg flex-col space-y-2 p-">
          <ul>
            <li class="w-fit">
      ...
      <!-- scrollable -->
      <div
        class="flex flex-col md:space-y-4 justify-center md:w-2/3 mt-20 mb-16 mx-11 md:mx-auto"
      >
        <div
        ...
        >
          ...
          <section
            id="experience"
            class="text-md tracking-wide h-full w-full space-y-7"
          >
            <Experience />
          ...
          <section id="none">
            <div class="text-xs text-center text-slate-500">
              <div
                class="flex md:hidden flex-row pb-3 justify-center space-x-5"
              >
                <a target="_blank" href="https://github.com/koushin07" class="">
                  <svg
                    class="h-7 w-7"
              ...
              Build with <span class="text-slate-300">VueJS</span> and
              <span class="text-slate-300">TailwindCSS</span>
              by yours truly
            </div>
          </section>
